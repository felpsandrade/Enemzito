...
$questoes = $conn->query("SELECT * FROM perguntas WHERE materia = 'Linguagens, Códigos e suas Tecnologias' ORDER BY RAND() LIMIT 10");
?>
...
<body>
    <h1>Prova de Linguagens e Códigos</h1>
